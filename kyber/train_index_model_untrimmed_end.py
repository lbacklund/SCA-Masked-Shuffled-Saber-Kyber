...
model_folder = "models/index_end/25k/"
modelName = 'kyber_index_end_'
#################################################
...
def load_traces():
    ...
    traces = np.load(data_folder+'cut_joined_traces_end.npy', mmap_mode="r")[:25000,:]
    labels = np.load(data_folder+'cut_joined_shuffle_labels_end.npy', mmap_mode="r")[:25000]
...
for model_name in os.listdir(model_folder):
    if fnmatch.fnmatch(model_name, "kyber_index_end_[0-9]*.h5"):
