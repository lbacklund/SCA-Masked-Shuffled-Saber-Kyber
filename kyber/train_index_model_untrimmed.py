...
def load_traces():
    ...
    traces = np.load(data_folder+'cut_joined_traces.npy', mmap_mode="r")[:25000*253,:]
    labels = np.load(data_folder+'cut_joined_shuffle_labels.npy', mmap_mode="r")[:25000*253]
