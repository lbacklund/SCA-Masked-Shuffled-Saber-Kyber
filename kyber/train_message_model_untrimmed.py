...
def load_traces():
    ...
    traces = np.load(data_folder+'cut_joined_traces.npy', mmap_mode="r")[:NUM_OF_TRACES*253,-2*225:-225]
...
for i in range(model_number,10):  
    ...
    train_model(traces, labels, mlp, model_folder + modelName, i, epochs=500, batch_size=1024, patience=30, classes=2)
