...
def load_traces(num_of_traces):
    ...
    traces = np.load(data_folder+'cut_joined_traces.npy', mmap_mode="r")[25000*253:25000*253+num_of_traces, :]
    labels = np.load(data_folder+'cut_joined_shuffle_labels.npy', mmap_mode="r")[25000*253:25000*253+num_of_traces]
