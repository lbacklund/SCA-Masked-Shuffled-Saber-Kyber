...
model_folder = "models/message_beginning/15k/"
modelName = 'saber_message_beginning_'
#################################################
...
def load_traces():
    ...
    traces = np.load(data_folder+'cut_joined_traces_beginning.npy', mmap_mode="r")[:15000, -210:]
    labels = np.load(data_folder+'cut_joined_message_labels_beginning.npy', mmap_mode="r")[:15000]
...
for model_name in os.listdir(model_folder):
    if fnmatch.fnmatch(model_name, "saber_message_beginning_[0-9]*.h5"):
