...
model_folder = "models/index_beginning/15k/"
modelName = 'saber_index_beginning_'
#################################################
...
def load_traces():
    ...
    traces = np.load(data_folder+'cut_joined_traces_beginning.npy', mmap_mode="r")[:15000,:]
    labels = np.load(data_folder+'cut_joined_shuffle_labels_beginning.npy', mmap_mode="r")[:15000]
...
for model_name in os.listdir(model_folder):
    if fnmatch.fnmatch(model_name, "saber_index_beginning_[0-9]*.h5"):
