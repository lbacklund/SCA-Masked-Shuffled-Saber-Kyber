...
def generate_message_trim_mask():
    # Calculate what indexes to keep
    message_sample_importance = np.load("sample_importance/message_sample_importance.npy")
    ...
    message_keep = message_keep + (450+210)
    ...
    # Save mask
    np.save("message_trim_mask.npy", message_keep)
