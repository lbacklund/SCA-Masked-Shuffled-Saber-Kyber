...
model_folder = "models/index/15k_trim1/"
...
def load_traces():
    ...
    traces = np.load(data_folder+'cut_joined_shuffle_traces.npy', mmap_mode="r")[:number_of_traces*253,:]
...
for i in range(model_number, 10):
    ...
    train_model(traces, labels, mlp, model_folder + modelName, i, epochs=500, batch_size=512, patience=30)
