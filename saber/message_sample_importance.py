...
def load_traces(num_of_traces):
    ...
    traces = np.load(data_folder+'cut_joined_traces.npy', mmap_mode="r")[15000*253:15000*253+num_of_traces, 450+210:-210]
    labels = np.load(data_folder+'cut_joined_message_labels.npy', mmap_mode="r")[15000*253:15000*253+num_of_traces]
...
for i, model in enumerate(models):
    ...
    # Save plots
    plt.savefig(f"sample_importance/message_sample_importance_{i}.png")
...
np.save("sample_importance/message_sample_importance.npy", sample_importance)
