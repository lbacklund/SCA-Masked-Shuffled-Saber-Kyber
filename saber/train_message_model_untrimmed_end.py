...
model_folder = "models/message_end/15k/"
modelName = 'saber_message_end_'
#################################################
...
def load_traces():
    ...
    traces = np.load(data_folder+'cut_joined_traces_end.npy', mmap_mode="r")[:15000, -3*210:-2*210]
    labels = np.load(data_folder+'cut_joined_message_labels_end.npy', mmap_mode="r")[:15000]
...
for model_name in os.listdir(model_folder):
    if fnmatch.fnmatch(model_name, "saber_message_end_[0-9]*.h5"):
